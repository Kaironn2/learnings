...
SECRET_KEY = 'django-insecure-$+hnd*%981_!g23dnb(dm_isird@p9fpg4ymhyxas%nfyrmzwv'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Poseidon Parking",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Poseidon Parking",
